        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-xl">
          {settingsSections.map((section) => {
            ...
            return (
              <div
                key={section.id}
                className="bg-gray-800/50 border border-gray-700 px-4 py-3 rounded-lg text-left transition-all duration-200 group hover:bg-gray-700/50 hover:border-gray-600 cursor-pointer"
                onClick={() => {
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="p-1.5 bg-gray-700/50 rounded-md group-hover:bg-gray-600/50 transition-colors">
