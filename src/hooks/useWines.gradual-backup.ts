...
const useWines = () => {
  ...
  // REFACTORING GRADUALE: Hook helpers per funzioni di supporto
  ...
  // REFACTORING GRADUALE: Helper functions ora gestite da useWinesHelpers
  ...
  // REFACTORING GRADUALE: refetchGiacenzaByVinoId ora gestito da useWinesHelpers
