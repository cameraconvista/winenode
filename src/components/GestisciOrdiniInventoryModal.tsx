...
interface GestisciOrdiniInventoryModalProps {
  isOpen: boolean;
  initialValue: number;
...
export default function GestisciOrdiniInventoryModal({
  isOpen,
  initialValue,
  onConfirm,
  onCancel,
  ...
  max = 100,
  originalValue
}: GestisciOrdiniInventoryModalProps) {
  ...
  // Genera 15 valori consecutivi centrati su currentValue (range 0-100)
  ...
  // Funzione conferma con messaggio
  const handleConfirm = () => {
    console.log('✅ Quantità confermata:', currentValue);
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl mx-4 w-full max-w-sm">
        ...
        <div className="px-6 py-8">
          <div
            ...
            aria-label={`Quantità, valore ${currentValue}`}
            role="spinbutton"
